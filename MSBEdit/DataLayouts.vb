    ...
    Public Shared Function generate(ByVal name As String)
        ...
        With layout
            ...
            ElseIf name = "mapPieces0" Then
                ...
                .add("SY", "f32", known)
                .add("SZ", "f32", known)
                .add("DrawGroup1", "h32", known)
                .add("DrawGroup2", "h32", known)
                .add("DrawGroup3", "h32", known)
                .add("DrawGroup4", "h32", known)
                .add("x48", "i32", unknown)
                .add("x4C", "i32", unknown)
                .add("x50", "i32", unknown)
                .add("x54", "i32", unknown)
                ...
                .add("p+x0C", "i16", unknown)
                .add("p+x0E", "i16", unknown)
                .add("p+x10", "i16", unknown)
                .add("p+x12", "i16", unknown)

                .add("p+x14", "i32", unknown)
                .add("p+x18", "i32", unknown)
                .add("p+x1C", "i32", unknown)
            ElseIf name = "objects1" Or name = "objects9" Then
                .add("&Name", "i32", advanced)
                .add("Type", "i32", advanced)
                .add("Index", "i32", known)
                .add("Model", "i32", known)
                ...
                .add("DrawGroup3", "h32", known)
                .add("DrawGroup4", "h32", known)
                .add("DispGroup1", "h32", known)
                .add("DispGroup2", "h32", known)
                .add("DispGroup3", "h32", known)
                .add("DispGroup4", "h32", known)
                .add("x58", "i32", unknown)
                .add("x5C", "i32", unknown)
                .add("x60", "i32", unknown)
                .setNameIndex(.fieldCount)
                ...
                .add("p+x24", "i16", unknown)
                .add("p+x26", "i16", unknown)

                .add("p+x28", "i32", unknown)
                .add("p+x2C", "i32", unknown)
            ElseIf name = "creatures2" Or name = "creatures10" Then
                .add("&Name", "i32", advanced)
                .add("Type", "i32", advanced)
                .add("Index", "i32", known)
                .add("Model", "i32", known)
                ...
                .add("p+x40", "i16", unknown)
                .add("p+x42", "i16", unknown)
                .add("p+x44", "i16", unknown)
                .add("p+x46", "i16", unknown)
            ...
            ElseIf name = "collision5" Then
                ...
                .add("p+x28", "i32", unknown)
                .add("p+x2C", "i32", unknown)
                .add("Vagrant Entity ID 1", "i32", known)
                .add("Vagrant Entity ID 2", "i32", known)
                .add("Vagrant Entity ID 3", "i32", known)
                .add("p+x3C", "i16", unknown)
                .add("p+x3E", "i16", unknown)
                .add("Bonfire Entity ID", "i32", known)
                .add("p+x44", "i32", unknown)
                .add("p+x48", "i32", unknown)
                .add("p+x4C", "i32", unknown)
                .add("Multiplayer ID", "i32", known)
            ...
            ElseIf name = "navimesh8" Then
                ...
                .add("p+x10", "i32", unknown)
                .add("p+x14", "i32", unknown)
                .add("NaviMeshGroup1", "h32", known)
                .add("NaviMeshGroup2", "h32", known)
                .add("NaviMeshGroup3", "h32", known)
                .add("NaviMeshGroup4", "h32", known)
                .add("p+x28", "i32", unknown)
                .add("p+x2C", "i32", unknown)
